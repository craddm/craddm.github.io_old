...
```{r basicPlot, fig.height = 4, fig.width = 7}
...
```{r indivAndGroup, fig.height = 4, fig.width = 8}
levCat.plot+
...
```{r indivNoGroup, fig.height = 4, fig.width = 8}
levCat.plot+
  geom_line(aes(group = interaction(Subject,variable),colour = variable,alpha = 0.2))+
  guides(alpha= "none")+
  theme_minimal()+
...
```{r diffPlot, fig.height = 4, fig.width = 7}
levCat.plot+
...
```{r indivDiffPlot, fig.height = 4, fig.width = 7}
