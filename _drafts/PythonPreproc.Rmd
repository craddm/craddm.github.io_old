...
```{r}
# newdat2 <- read_csv('C:\\Users\\Matt\\Documents\\temp\\my_epochs.csv')
# EEGdat2 <- gather(newdat2,electrode,amplitude,-time,-epoch,-condition)
# 
# theme_set(theme_bw())
# 
# EEGdat2 %>%
#   ggplot(aes(time,amplitude))+
#   stat_summary(fun.data = mean_se,geom = "line",aes(colour = condition))
