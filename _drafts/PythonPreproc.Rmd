...
An issue doing EEG analysis in R at the moment is that the tools just don't exist to do a lot of the typical pre-processing steps. There are a few fledgling packages around that implement bits and pieces here and there, but nothing that takes you all the way from your raw data to nicely formatted output.
...
v4plot + scale_fill_gradientn(colors = matplotlibRdBu(10),
                              limits = c(-5,5),
                              guide = "colourbar",
                              oob = squish)
